...
bool Population::epoch(int generation) {
	...
	cout << "PRE tournamement selection species" << endl;
	for (curspecies = species.begin(); curspecies != species.end(); ++curspecies) {
		//Print out for Debugging/viewing what's going on 
		std::cout << "orig fitness of Species" << (*curspecies)->id << "(Size " << (*curspecies)->organisms.size() << "): " << (*((*curspecies)->organisms).begin())->orig_fitness << " last improved " << ((*curspecies)->age - (*curspecies)->age_of_last_improvement) << std::endl;
	}
	...
	cout << "POST tournamement selection species: " << species.size() << endl;
	for (curspecies = species.begin(); curspecies != species.end(); ++curspecies) {
		//Print out for Debugging/viewing what's going on 
		cout << "orig fitness of Species" << (*curspecies)->id << "(Size " << (*curspecies)->organisms.size() << "): " << endl; // (*((*curspecies)->organisms).begin())->orig_fitness << " last improved " << ((*curspecies)->age - (*curspecies)->age_of_last_improvement) << std::endl;
	}
...
//	}
	...
	cout << "POST reproduction selection species: " << species.size() << endl;
	for (curspecies = species.begin(); curspecies != species.end(); ++curspecies) {
		//Print out for Debugging/viewing what's going on 
		cout << "orig fitness of Species" << (*curspecies)->id << "(Size " << (*curspecies)->organisms.size() << "): " << endl; // (*((*curspecies)->organisms).begin())->orig_fitness << " last improved " << ((*curspecies)->age - (*curspecies)->age_of_last_improvement) << std::endl;
	}
...
void Population::tournamentSelect(int generation) {
	...
	cout << "In tournamement selection species (2)" << endl;
	for (vector<Species*>::iterator curspecies = species.begin(); curspecies != species.end(); ++curspecies) {
		//Print out for Debugging/viewing what's going on 
		cout << "orig fitness of Species" << (*curspecies)->id << "(Size " << (*curspecies)->organisms.size() << "): " << endl;
	}
	...
	cout << "In tournamement selection species (3): " << species.size() << endl;
	for (vector<Species*>::iterator curspecies = species.begin(); curspecies != species.end(); ++curspecies) {
		//Print out for Debugging/viewing what's going on 
		cout << "orig fitness of Species" << (*curspecies)->id << "(Size " << (*curspecies)->organisms.size() << "): " << "num offsprings: " << (*curspecies)->expected_offspring << endl;
	}

	//Delete species that are empty
	cout << "species size: " << species.size() << endl;
	vector<Species*>::iterator curspecies = species.begin();
	vector<Species*>::iterator deadspecies;
	while (curspecies != species.end()) {
		if (((*curspecies)->organisms.size()) == 0) {
			delete (*curspecies);
	...
	//set species' expected_offspring to the size of the species for now.

	for (vector<Species*>::iterator curspecies = species.begin(); curspecies != species.end(); ++curspecies) {
		(*curspecies)->expected_offspring = (*curspecies)->size(); 
	}
